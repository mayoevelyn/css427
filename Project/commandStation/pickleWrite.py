...
fp = open("../webServer/sprinklerPage/sequenceNumbers/formValveSeqNum.pkl", "w")
pickle.dump(valveSeqNum, fp)

fp = open("../webServer/sprinklerPage/sequenceNumbers/formSensorsSeqNum.pkl", "w")
pickle.dump(sensorsSeqNum, fp)

fp = open("../webServer/sprinklerPage/sequenceNumbers/formPreferencesSeqNum.pkl", "w")
